...
export function AboutStoryMobile() {
  ...
  return (
    <motion.section
      ...
      className="max-w-6xl mx-auto pt-8 pb-16 px-8 tablet-xs:mb-8 tablet-xs:p-24 space-y-8 h-auto"
    >
      <motion.ol
        initial="hidden"
        animate="visible"
        ...
        <div className="relative flex p-8 text-balance">
          <li>
            ...
            >
              ...
              11 erzählte ich meiner Tante davon, wie faszinierend die Wolken
              sind und um welche Wolke es sich handelt, die ich in einem Buch
              entdeckt habe. Zuerst habe ich Wolkenformationen mit Radarbilden
              abgeglichen – so erkannte ich schnell Muster, die mir verrieten,
              ob es bald regnen könnte.
            </motion.p>
            <motion.p
              initial="hidden"
              whileInView="visible"
        ...
        <div className="relative flex p-8 text-balance">
          <li>
            ...
            >
              ...
              „Rheinpegel“-Podcast folgten. Von September 2022 bis Juli 2024 war
        ...
        <div className="relative flex p-8 text-balance">
          <li>
            ...
            >
              ...
              Vergleich von Modellen, Erstellen von Grafiken, Pflege der
              Community oder auch Live-Ticker bei brisanten Wetterlagen.
            </motion.p>
            <motion.p
              initial="hidden"
              whileInView="visible"
            ...
            >
              ...
              Spenden meiner Community motiviert mich sehr – an dieser Stelle
