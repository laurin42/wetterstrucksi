...
export function AboutStoryDesktop() {
  return (
    <section className="max-w-6xl mx-auto pt-8 pb-16 tablet-xs:mb-8  space-y-8 h-auto">
      <ol className="relative border-text/40 text-lg font-thin">
        <div className="relative flex justify-start">
          <div className="absolute top-16 bottom-0 left-1/2 w-0.5 -translate-x-1/2 bg-text/30"></div>

          <div className="absolute w-5 h-5 top-16 left-1/2 bg-header-background rounded-full -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="relative flex justify-end -mt-116">
          <div className="absolute top-116 bottom-0 left-1/2 w-0.5 bg-text/30 -translate-x-1/2"></div>
        ...
        <div className="relative flex justify-start mt-8">
          <div className="absolute -top-8 bottom-0 left-1/2 w-0.5 bg-text/30 -translate-x-1/2"></div>
          <div className="absolute w-5 h-5 top-16 left-1/2 bg-header-background rounded-full -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="relative flex justify-end -mt-144">
          <div className="absolute top-144 bottom-0 left-1/2 w-0.5 -translate-x-1/2 bg-linear-to-b from-text/30 to-transparent"></div>
          ...
          <ol className="w-1/2">
            <li>
              <div className="p-8 ml-24 text-balance bg-foreground-secondary/44 rounded-md">
                ...
                <p className="leading-relaxed md:mb-4 mb-8">
      ...
      <div className="mt-32 relative flex flex-col w-full justify-center items-center text-center font-light text-lg text-balance p-16">
        <div className="absolute top-2 left-2 tablet-xs:left-8 w-8 h-8 border-t-4 border-l-4 border-accent/80 rounded-xs"></div>
        <div className="absolute bottom-2 right-2 tablet-xs:right-8 w-8 h-8 border-b-4 border-r-4 border-accent/80 rounded-xs"></div>
