...
export function FaqAccordion({ items }: FaqAccordionProps) {
  return (
    <section className="w-full max-w-5xl mx-auto gap-y-4 py-16 px-4 tablet-xs:py-16 tablet-xs:px-16 tablet-xs:rounded-lg border border-white/32 tablet-xs:shadow-lg">
