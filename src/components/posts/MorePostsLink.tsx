...
export default function MorePostsLink({ href, label }: MorePostsLinkProps) {
  ...
  return (
    ...
    >
      <Link
        href={href}
        className="inline-flex items-center gap-2 px-16 py-3 rounded-md bg-accent text-text-white text-base md:text-lg font-semibold hover:bg-accent/80 transition-colors"
      >
        {label}
      </Link>
    </motion.div>
