...
export default function WeatherBlogHero() {
  ...
  return (
    <section className="relative flex flex-col h-auto w-full justify-center py-8 px-4 tablet-xs:px-8 tablet-xs:rounded-md tablet-xs:mb-2 overflow-hidden min-h-20">
      <Image
        src={backgroundImage}
        alt="Hintergrundbild"
        fill
