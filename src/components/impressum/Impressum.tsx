...
export default function Impressum() {
  return (
    <motion.section className="tablet-xs:py-16">
      <motion.div className="flex flex-col gap-y-2 max-w-6xl tablet-xs:shadow-md shadow-header-background/32 tablet-xs:border border-white/32 tablet-xs:rounded-lg mx-auto p-4 md:p-8 rounded-t-sm leading-tight">
        ...
        <p>
          ...
          als solche gekennzeichnet. Bei Bekanntwerden von
          Urheberrechtsverletzungen werden derartige Inhalte umgehend entfernt.
        </p>
      </motion.div>
    </motion.section>
  );
